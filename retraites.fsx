...
let simulationCurrentBasedOnPercentSalaryIncreaseFixedBirthDate percentIncrease = simulationBasedOn CurrentSalaries.calculatePension percentIncrease 1980m
...
let simulationCurrentCipavBasedOnPercentSalaryIncreaseFixedBirthDate percentIncrease = simulationBasedOn CurrentCipav.calculatePension percentIncrease 1980m
...
let simulationReformedSalariesBasedOnPercentSalaryIncreaseFixedBirthDate percentIncrease = simulationBasedOn Reformed.calculatePensionSalaries percentIncrease 1980m
...
let replacementRateSeries = "Taux de remplacement selon les revenus sur toute une carrière (revenus fixes) et par régime",
    "percent",
    [
        ("Régime général actuel, né en 1961", ""), simulationCurrentBasedOnSameSalary 1961m |> Seq.map (fun (x, y) -> x, y.NetReplacementRate)
